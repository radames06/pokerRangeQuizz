...
export class RangePoker {
    ...
    public getClone() {
        var clone: RangePoker = new RangePoker();
        clone.setName(this.rangeName);
        clone.setOriginalText(this.originalText);
        clone.setOwner(this.owner);
        clone.setMap(this.rangeMap);
        return clone;
    }

    public getMap() {return this.rangeMap}
    public setMap(map: Map<String, RangeVal>) {
        this.rangeMap = map;
    }
    ...
    public setOriginalText(text: String) {
    ...
    public getJson() {
        return JSON.stringify({ [this.rangeName.toString()]: {originalText: this.originalText} })
    }
}

export class rangeFormatted {
    private name: String;
    private originalText: String;
    private owner: String;

    constructor(name: String, originalText: String, owner:String) {
        this.name = name;
    ...
    public getOriginalText() { return this.originalText; }
    public setOriginalText(originalText: String) { this.originalText = originalText; }
